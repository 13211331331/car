...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
            ...
            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>在线报修管理</span></div></h3>
				<ul id="submenu2">
			...
			<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>缴费查看</span></div></h3>
				<ul id="submenu3">
					<li><a href="jiaofeijilu_list2.jsp" target="frmright">缴费查看</a></li>
				</ul>
			
		<!--	<h3 menuid="4"  id="menu4" onclick="showsubmenu(4)" toggleGroup="on" class="menutitle"><div class="bt4"><span>站内新闻管理</span></div></h3>
				<ul id="submenu4">
