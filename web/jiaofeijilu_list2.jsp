...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>用户名</td><td bgcolor='#CCFFFF'>姓名</td><td bgcolor='#CCFFFF'>年份</td><td bgcolor='#CCFFFF'>月份</td><td bgcolor='#CCFFFF'>费用类型</td><td bgcolor='#CCFFFF'>费用金额</td><td bgcolor='#CCFFFF' width='80' align='center'>是否已交</td>
  ...
  int page_record=15;
   ...
   int zgs=0;
				int zys=0;
String fysql="select count(id) as ss from jiaofeijilu where yonghuming='"+request.getSession().getAttribute("username")+"'";
  ...
  sql="select  * from jiaofeijilu where  yonghuming='"+request.getSession().getAttribute("username")+"'";
...
%>
 ...
 <td width='80' align='center'><%=issh%></td>
    ...
    <td width="90" align="center"><a href="jiaofeijilu_detail.jsp?id=<%=id%>">详细</a></td>
  </tr>
  	<%
  }
  }
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="jiaofeijilu_list2.jsp?page=1">首页</a>　<a href="jiaofeijilu_list2.jsp?page=<%= curpage-1%>">上一页</a>　<A href="jiaofeijilu_list2.jsp?page=<%= curpage+1%>">下一页</A>　<a href="jiaofeijilu_list2.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
