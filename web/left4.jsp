...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
            ...
            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2">临时车位管理</div></h3>
				<ul id="submenu2">
					...
					<li><a href="carPositionApplyAudit.jsp" target="frmright">车位申请审核</a></li>
