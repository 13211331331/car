...
if(document.form1.wujianmingcheng.value==""){alert("请输入物件名称");document.form1.wujianmingcheng.focus();return false;}
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="baoxiujilu_updt_post.jsp?id=<%=id %>">
  修改报修记录:
  <br><br>
  <%
  ...
  shenbaoren=RS_result.getString("shenbaoren");
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     <tr><td>报修单号：</td><td><input name='baoxiudanhao' type='text' id='baoxiudanhao' value='<%= baoxiudanhao%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
     <tr><td>物件名称：</td><td><input name='wujianmingcheng' type='text' id='wujianmingcheng' size='50' value='<%=wujianmingcheng%>' style='border:solid 1px #000000; color:#666666'/></td></tr>
     <tr><td>故障时间：</td><td><input name='guzhangshijian' type='text' id='guzhangshijian' value='<%= guzhangshijian%>' onclick="fPopCalendar(event,this,this)" readonly='readonly'  /></td></tr>
     <tr><td>严重程度：</td><td><select name='yanzhongchengdu' id='yanzhongchengdu'><option value="轻微">轻微</option><option value="中等">中等</option><option value="严重">严重</option></select></td></tr><script language="javascript">document.form1.yanzhongchengdu.value='<%=yanzhongchengdu%>';</script>
     <tr><td>故障描述：</td><td><textarea name='guzhangmiaoshu' cols='50' rows='5' id='guzhangmiaoshu' style='border:solid 1px #000000; color:#666666'><%=guzhangmiaoshu%></textarea></td></tr>
     ...
     <tr style='display:none'><td>维修时间：</td><td><input name='weixiushijian' type='text' id='weixiushijian' value='<%= weixiushijian%>' onclick="fPopCalendar(event,this,this)" readonly='readonly'  /></td></tr>
     ...
     <tr><td>申报人：</td><td><input name='shenbaoren' type='text' id='shenbaoren' value='<%= shenbaoren%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
