...
function gow()
{
	document.location.href="youqinglianjie_add.jsp?jihuabifffanhao="+document.form1.jihuabifffanhao.value;
}
</script>
  <body >
    <%
 ...
 //islbdq }
  ...
  <br><br>
   ...
   <tr><td>网站名称：</td><td><input name='wangzhanmingcheng' type='text' id='wangzhanmingcheng' value='' size='50' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr>
<tr><td>网址：</td><td><input name='wangzhi' type='text' id='wangzhi' value='' size='50' style='border:solid 1px #000000; color:#666666' />&nbsp;*</td></tr>
<tr><td>LOGO：</td><td><input name='LOGO' type='text' id='LOGO' size='50' value=''  style='border:solid 1px #000000; color:#666666' />&nbsp;<input type='button' value='上传' onClick="up('LOGO')" style='border:solid 1px #000000; color:#666666'/>&nbsp;*</td></tr>
