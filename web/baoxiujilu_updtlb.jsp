...
if(document.form1.wujianmingcheng.value==""){alert("请输入物件名称");document.form1.wujianmingcheng.focus();return false;}
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="baoxiujilu_updt_postlb.jsp?id=<%=id %>">
  设置报修记录:
  <br><br>
  <%
  ...
  baoxiudanhao=RS_result.getString("baoxiudanhao");wujianmingcheng=RS_result.getString("wujianmingcheng");guzhangshijian=RS_result.getString("guzhangshijian");yanzhongchengdu=RS_result.getString("yanzhongchengdu");guzhangmiaoshu=RS_result.getString("guzhangmiaoshu");weixiufeiyong=RS_result.getString("weixiufeiyong");weixiujieguo=RS_result.getString("weixiujieguo");weixiushijian=RS_result.getString("weixiushijian");weixiuren=RS_result.getString("weixiuren");shenbaoren=RS_result.getString("shenbaoren");
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr><td>维修费用：</td><td><input name='weixiufeiyong' type='text' id='weixiufeiyong' value='<%= weixiufeiyong%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
     <tr><td>维修结果：</td><td><textarea name='weixiujieguo' cols='50' rows='5' id='weixiujieguo' style='border:solid 1px #000000; color:#666666'><%=weixiujieguo%></textarea></td></tr>
     <tr><td>维修时间：</td><td><input name='weixiushijian' type='text' id='weixiushijian' value='<%= weixiushijian%>' onclick="fPopCalendar(event,this,this)" readonly='readonly' style='border:solid 1px #000000; color:#666666' /></td></tr>
     <tr><td>维修人：</td><td><input name='weixiuren' type='text' id='weixiuren' value='<%= weixiuren%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
