...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="1"  id="menu1" onclick="showsubmenu(1)" toggleGroup="on" class="menutitle"><div class="bt1"><span>修改密码</span></div></h3>
				<ul id="submenu1">
					
					<li><a href="mod.jsp" target="frmright">修改密码</a></li>
				</ul>

            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2">缴费管理</div></h3>
				<ul id="submenu2">
					<li><a href="kuaidixinjian_add.jsp" target="frmright">缴费记录添加</a></li>
					<li><a href="kuaidixinjian_list2.jsp" target="frmright">缴费记录查询</a></li>
				</ul>
			
			<!--<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>通知公告管理</span></div></h3>
				<ul id="submenu3">
