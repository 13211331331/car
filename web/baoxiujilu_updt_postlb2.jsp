...
String sql="update baoxiujilu set pingfen='"+pingfen+"',pingyu='"+pingyu+"', baoxiudanhao='"+baoxiudanhao+"',wujianmingcheng='"+wujianmingcheng+"',guzhangshijian='"+guzhangshijian+"',yanzhongchengdu='"+yanzhongchengdu+"',guzhangmiaoshu='"+guzhangmiaoshu+"',weixiufeiyong='"+weixiufeiyong+"',weixiujieguo='"+weixiujieguo+"',weixiushijian='"+weixiushijian+"',weixiuren='"+weixiuren+"',shenbaoren='"+shenbaoren+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('设置成功!!');location.href='baoxiujilu_list2.jsp';</script>");
%>
  </body>
</html>
