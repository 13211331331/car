...
%>
  <tr>
    ...
    <td width="94" align="center"><%=addtime %></td>
    <td width="52" align="center"><a href="sh.jsp?id=<%=id%>&yuan=<%=issh%>&tablename=yonghuzhuce" onClick="return confirm('确定要执行此操作？');"><%=issh%></a></td>
    <td width="71" align="center"><a href="yonghuzhuce_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=yonghuzhuce" onClick="return confirm('真的要删除？')">删除</a> <a href="yonghuzhuce_detail.jsp?id=<%=id%>" target="_blank"></a></td>
  </tr>
  	<%
  }
   }
