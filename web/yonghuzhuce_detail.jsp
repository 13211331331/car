...
<html>
  <head>
    ...
    <title>用户注册详细</title><script language="javascript" src="js/hsgrili.js"></script>
...
function check()
{
  ...
  <td width='11%'>用户名：</td>
    ...
    <td width="33%" colspan="2" rowspan="8" align="center"><img src="<%=touxiang%>" width="227" height="214"></td>
  </tr><tr>
    <td width='11%'>姓名：</td>
